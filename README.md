...
![alt text](https://github.com/n1els3n/preview/1.png)

![alt text](https://github.com/n1els3n/preview/2.png)

![alt text](https://github.com/n1els3n/preview/3.png)

### [WARNING!]: When you run the command it will make changes to your settings folder, so if you already have your own work in that folder it is recommended to make a backup.
